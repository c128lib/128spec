...
/*.eval config_128spec("print_context_description", false)*/
sfspec: :init_spec()
  ...
  :it("passes if all masked bits are set")
    ...
    sec
    sed
    :assert_p_has_masked_bits_set #%00001101: _128SPEC.assertion_passed_subroutine: _128SPEC.assertion_failed_subroutine

    lda #%10101010
    pha
    plp
    :assert_p_has_masked_bits_set #%10101010: _128SPEC.assertion_passed_subroutine: _128SPEC.assertion_failed_subroutine
  ...
  :it("fails if at least one of masked bits is not set")
    ...
    cld
    :assert_p_has_masked_bits_set #%00001101: _128SPEC.assertion_failed_subroutine: _128SPEC.assertion_passed_subroutine
    plp
    php
...
.print "Warning: Bits cleared does not work with %10101010 being passed. B (%00010000) flag is being set anyway"
  ...
  :it("fails if at least one of masked bits is not set")
    ...
    sed
    :assert_p_has_masked_bits_cleared #%00001101: _128SPEC.assertion_failed_subroutine: _128SPEC.assertion_passed_subroutine
    plp
    php
  ...
  :it("passes if Status register is equal to specified value")
    ...
    pha
    plp
    :assert_p_equal tmp: _128SPEC.assertion_passed_subroutine: _128SPEC.assertion_failed_subroutine
  ...
  :it("passes if Status register is not equal to specified value")
    ...
    plp
    clc
    :assert_p_equal tmp: _128SPEC.assertion_failed_subroutine: _128SPEC.assertion_passed_subroutine
  ...
  :it("fails when Z flag is cleared")
    lda #1
    :assert_z_set _128SPEC.assertion_failed_subroutine: _128SPEC.assertion_passed_subroutine
  ...
  :it("fails when Z flag is set")
    lda #0
    :assert_z_cleared _128SPEC.assertion_failed_subroutine: _128SPEC.assertion_passed_subroutine
  ...
  :it("fails when Carry flag is cleared")
    clc
    :assert_c_set _128SPEC.assertion_failed_subroutine: _128SPEC.assertion_passed_subroutine
  ...
  :it("fails when Carry flag is set")
    sec
    :assert_c_cleared _128SPEC.assertion_failed_subroutine: _128SPEC.assertion_passed_subroutine
  ...
  :it("fails when Decimal flag is cleared")
    cld
    :assert_d_set _128SPEC.assertion_failed_subroutine: _128SPEC.assertion_passed_subroutine
  ...
  :it("fails when Decimal flag is set")
    sed
    :assert_d_cleared _128SPEC.assertion_failed_subroutine: _128SPEC.assertion_passed_subroutine
    cld
  ...
  :it("fails when I flag is cleared")
    cli
    :assert_i_set _128SPEC.assertion_failed_subroutine: _128SPEC.assertion_passed_subroutine
  ...
  :it("fails when I flag is set")
    sei
    :assert_i_cleared _128SPEC.assertion_failed_subroutine: _128SPEC.assertion_passed_subroutine
    cli
  ...
  :it("fails when N flag is cleared")
    lda #1
    :assert_n_set _128SPEC.assertion_failed_subroutine: _128SPEC.assertion_passed_subroutine
  ...
  :it("fails when N flag is set")
    lda #-1
    :assert_n_cleared _128SPEC.assertion_failed_subroutine: _128SPEC.assertion_passed_subroutine
  ...
  :it("fails when V flag is cleared")
    clv
    :assert_v_set _128SPEC.assertion_failed_subroutine: _128SPEC.assertion_passed_subroutine
  ...
  :it("fails when V flag is set")
    bit byte_with_bit_6_set
    :assert_v_cleared _128SPEC.assertion_failed_subroutine: _128SPEC.assertion_passed_subroutine
