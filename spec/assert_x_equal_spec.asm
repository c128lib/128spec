...
sfspec: :init_spec()
  ...
  :it("works for all values of X register");{
    ...
    .for (var expected = 0;expected < 256; expected++) {
      .if (x == expected) {
        ...
        ldx #x
        :assert_x_equal #expected : _128SPEC.assertion_failed_subroutine : _128SPEC.assertion_passed_subroutine
      }
    }
  }
  ...
  :it("does not affect Y register")
    ...
    ldx #5
    :assert_x_equal #5
    :assert_x_equal #6 : _128SPEC.assertion_failed_subroutine : _128SPEC.assertion_passed_subroutine
    :assert_y_equal #7
  ...
  :it("does not affect A register")
    ...
    ldx #68
    :assert_x_equal #68
    :assert_x_equal #69 : _128SPEC.assertion_failed_subroutine : _128SPEC.assertion_passed_subroutine
