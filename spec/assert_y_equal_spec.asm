...
assert_y_equal_works_for_all_values_of_y: {
  ...
  .for (var expected = 0;expected < 256; expected++) {
    .if (y == expected) {
      ...
      ldy #y
      :assert_y_equal #expected: _128SPEC.assertion_failed_subroutine: _128SPEC.assertion_passed_subroutine
    }
  }
}
...
assert_y_equal_does_not_affect_x:
  ...
  ldy #5
  :assert_y_equal #5
  :assert_y_equal #6: _128SPEC.assertion_failed_subroutine: _128SPEC.assertion_passed_subroutine
  :assert_x_equal #7
...
assert_y_equal_does_not_affect_a:
  ...
  ldy #68
  :assert_y_equal #68
  :assert_y_equal #69: _128SPEC.assertion_failed_subroutine: _128SPEC.assertion_passed_subroutine
  :assert_a_equal #9
